  ...
  return (
    <div className="space-y-16 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-20">
      ...
      <div className="grid gap-16">
        ...
        >
          <p>Transform your Android device into a mobile architectural node. This allows you to run high-fidelity audits on the go using Termux.</p>
          <ol className="list-decimal pl-5 space-y-4">
            <li>
              <strong>Install Termux:</strong> Download from F-Droid (not Play Store) for the latest security updates.
            </li>
            <li>
              <strong>Initialize Environment:</strong> Open Termux and execute the update sequence:
              <CodeSnippet code={`pkg update && pkg upgrade
pkg install python git`} />
            </li>
            <li>
              <strong>Install Sovereign Core:</strong> Deploy the necessary TUI libraries:
              <CodeSnippet code={`pip install rich`} />
            </li>
            <li>
              <strong>Execute Artifact:</strong> Run your synthesized Python artifact:
              <CodeSnippet code={`python sovereign_artifact.py`} />
            </li>
          </ol>
          <p className="text-xs text-blueprint/50 italic">Note: For permission issues, run `termux-setup-storage` to grant access to local files.</p>
        </TutorialSection>
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-3">
            ...
            <li><strong>Zero-Failure Linting:</strong> Before synthesis, your input objectives are scanned for logical dead-ends.</li>
            <li><strong>Paid API Gateway:</strong> High-fidelity visual synthesis requires a paid GCP project.</li>
          </ul>
        </TutorialSection>
        ...
        >
          <p>Export your architectural artifacts seamlessly. Use these commands to initialize your Sovereign Repository:</p>
...
git push -u origin main`} />
          <p className="text-xs italic text-blueprint/50 mt-4">Note: GitHub mobile app can be used to monitor push events on Android.</p>
        </TutorialSection>
      </div>
